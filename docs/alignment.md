---
layout: page
title: Read mapping and reference genome
navigation: 13
---
...
After sequencing reads are pre-processed and their quality is checked, next step is to **map** them to a reference genome or transcriptome.
...
Multiples **aligners** were developped over the last decades, using different **algorithms**: 
